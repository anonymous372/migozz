...
const Tooltip = ({ label, children }) => {
  return (
    <div className="relative inline-block group focus-within:group">
      ...
      <div
        role="tooltip"
        className="pointer-events-none absolute left-1/2 top-full mt-2 -translate-x-1/2 whitespace-nowrap opacity-0 scale-95 transform transition-all duration-150 delay-200 group-hover:opacity-100 group-hover:scale-100 group-focus-within:opacity-100"
      >
